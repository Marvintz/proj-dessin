console.log("Bienvenue sur l'appli!");
...
const createCanvas = () =>{
        ...
        clearBtn.addEventListener('click', function(e){
                context.clearRect(0, 0, context.canvas.width, context.canvas.height); // pour dégager
                clickX=[];
                clickY=[];
                clickDrag=[];
                paint=false;
        ...
        context.fillRect(0,0,context.canvas.width, context.canvas.height);
                ...
                // pour changer la couleur  la couleur 
